...
; Characteristics of each move.
	...
	move DOUBLESLAP,   ATTACK_TWICE_EFFECT,  		30, NORMAL,       100, 10 ; jo3n3nnote - changed from TWO_TO_FIVE_ATTACKS_EFFECT, pwr 15
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  25, NORMAL,       100, 15 ; jo3n3nnote - changed from pwr18, acc 85
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        80, NORMAL,        85, 20
	move PAY_DAY,      PAY_DAY_EFFECT,              40, NORMAL_SPC,   100, 20 ; jo3n3nnote - changed from NORMAL
	move FIRE_PUNCH,   BURN_SIDE_EFFECT1,           75, FIRE,         100, 15
	move ICE_PUNCH,    FREEZE_SIDE_EFFECT1,         75, ICE,          100, 15
	move THUNDERPUNCH, PARALYZE_SIDE_EFFECT1,       75, ELECTRIC,     100, 15
	move SCRATCH,      NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        90, NORMAL,        85, 15 ; jo3n3nnote - changed from pwr 55, acc 100, pp 30, normal critchance (same as CRABHAMMER)
	...
	move BIND,         TRAPPING_EFFECT,             15, NORMAL_SPC,    85, 20 ; jo3n3nnote - changed from NORMAL, acc 75
	...
	move MEGA_KICK,    NO_ADDITIONAL_EFFECT,       	80, NORMAL,        85, 20 ; marcelnote - changed from acc 75 - jo3n3nnote - changed from pwr 120, pp 5 (same as MEGA_PUNCH)
	...
	move POISON_STING, POISON_SIDE_EFFECT1,         30, POISON,       100, 35 ; marcelnote - changed from pwr 15 - jo3n3nnote - changed from pwr 20
	...
	move ROAR,         ATTACK_DOWN1_EFFECT,         50, NORMAL_SPC,    85, 20 ; marcelnote - changed from acc 100 - jo3n3nnote - changed from NORMAL, SWITCH_AND_TELEPORT_EFFECT, pwr 0
	...
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          150, NORMAL_SPC,    90,  5 ; jo3n3nnote - changed from NORMAL
	move PECK,         NO_ADDITIONAL_EFFECT,        35, FLYING,       100, 35
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        80, FLYING,       100, 20 ; jo3n3nnote - changed from base critchance
	...
	move ABSORB,       DRAIN_HP_EFFECT,             40, GRASS,         90, 20 ; marcelnote - changed from pwr 20 - jo3n3nnote - changed from pwr 30, acc 100
	move MEGA_DRAIN,   DRAIN_HP_EFFECT,             80, GRASS,         95, 10 ; marcelnote - changed from pwr 40 - jo3n3nnote - changed from pwr 60, acc 100
	...
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        50, ROCK,         100, 25 ; marcelnote - changed from acc 65 - jo3n3nnote - changed from acc 85, pp 15
	...
	move RAGE,         RAGE_EFFECT,                 40, DRAGON,       100, 20 ; jo3n3nnote - changed from NORMAL, pwr 20
	...
	move HARDEN,       SPECIAL_UP1_EFFECT,           0, NORMAL,       100, 30 ; jo3n3nnote - changed from DEFENSE_UP1_EFFECT
	move MINIMIZE,     EVASION_UP1_EFFECT,           0, NORMAL,       100, 20
	move SMOKESCREEN,  ACCURACY_DOWN1_EFFECT,        0, NORMAL,       100, 20
	move CONFUSE_RAY,  CONFUSION_EFFECT,             0, GHOST,        100, 10
	move WITHDRAW,     REFLECT_EFFECT,               0, WATER,        100, 40 ; jo3n3nnote - changed from DEFENSE_UP1_EFFECT
	...
	move SELFDESTRUCT, EXPLODE_EFFECT,             250, NORMAL_SPC,   100,  5 ; jo3n3nnote - changed from NORMAL, pwr 130
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       100, NORMAL_SPC,    75, 10 ; jo3n3nnote - changed from NORMAL
	...
	move SWIFT,        SWIFT_EFFECT,                60, NORMAL_SPC,   100, 20 ; jo3n3nnote - changed from NORMAL
	move SKULL_BASH,   CHARGE_EFFECT,              120, NORMAL,       100, 15 ; marcelnote - changed from pwr 100
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  20, ROCK,         100, 15 ; jo3n3nnote - changed from NORMAL
	...
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL_SPC,        85, 20 ; jo3n3nnote - changed from NORMAL
	...
	move ACID_ARMOR,   LIGHT_SCREEN_EFFECT,          0, POISON,       100, 40 ; jo3n3nnote - changed from DEFENSE_UP2_EFFECT
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,        90, WATER,         85, 15 ; jo3n3nnote - changed from pp 10
	move EXPLOSION,    EXPLODE_EFFECT,             250, NORMAL,       100,  5 ; jo3n3nnote - changed from pwr 170
	...
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,        75, ROCK,          90, 10 ; jo3n3nnote - changed from base critchance
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,        90, 15
	move SHARPEN,      ATTACK_UP1_EFFECT,            0, NORMAL,       100, 30
	move CONVERSION,   CONVERSION_EFFECT,            0, NORMAL,       100, 30
	move TRI_ATTACK,   TRI_ATTACK_EFFECT,           80, NORMAL_SPC,   100, 10 ; marcelnote - changed from NO_ADDITIONAL_EFFECT - jo3n3nnote - changed from NORMAL
